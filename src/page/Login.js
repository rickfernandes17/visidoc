        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form className="mt-8 space-y-6" action="#" method="POST">
            ...
            <div>
              ...
              <a href="#" className="group relative flex w-full justify-center rounded-md border border-transparent bg-cyan-600 py-2 px-4 text-sm font-medium text-white hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 mt-2"
              >Cadastrar</a>
            </div>
          </form>
        </div>
